    ...
    <Link to="/" className="flex items-center gap-2">
      ...
      {!compact && (
        <div className="leading-tight">
          <div className="font-display text-base font-extrabold tracking-tight">REMAX<br />&nbsp;Única Escolha&nbsp;&nbsp;<span className="text-[color:var(--color-brand-red)]">Academy</span></div>
